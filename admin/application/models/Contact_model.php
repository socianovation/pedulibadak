...
class Contact_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id,email,message,created_at');
        $this->datatables->from('contact');
        //add this line for join
        //$this->datatables->join('table2', 'contact.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('contact/read/$1'),'Read')." | ".anchor(site_url('contact/update/$1'),'Update')." | ".anchor(site_url('contact/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
