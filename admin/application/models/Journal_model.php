...
class Journal_model extends CI_Model
{
    ...
    function json() {
        ...
        //$this->datatables->join('table2', 'journal.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('journal/read/$1'),'Read')." | ".anchor(site_url('journal/update/$1'),'Update')." | ".anchor(site_url('journal/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
